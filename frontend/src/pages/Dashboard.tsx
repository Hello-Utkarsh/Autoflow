    ...
    return (
        <div className='bg-[rgb(21,20,27)] min-h-screen bg-[linear-gradient(15deg,_rgba(21,20,27,1)_9%,_rgba(22,19,37,1)_26%,_rgba(38,12,79,1)_50%,_rgba(52,5,119,1)_75%,_rgba(56,3,129,1)_87%)] relative flex px-8'>
            <div className='flex mt-[10vh]'>
                <motion.div initial={open ? 'hidden' : 'visible'} variants={{ hidden: { width: 0, opacity: 0 }, visible: { width: '18vw', opacity: 1, transition: { duration: 0.5, delay: 0.2 } } }} animate={open ? 'visible' : 'hidden'} className='h-[80vh] bg-[#340577] rounded-md'>
                </motion.div>
            ...
            <motion.span initial={{ opacity: 0, y: 80 }} viewport={{ once: true }} animate={{ opacity: 1, y: 0, transition: { duration: 0.5 } }} className='absolute bottom-10 left-[30%] w-[40%] flex gap-2'>
